        ...
        private async Task UpdateUi(ExtendedLabel view, TextBlock control)
        {
            if ((view != null) && (control != null))
            {
                ...
                if (!string.IsNullOrEmpty(view.FontName))
                {
                    ...
                    {
                        control.FontFamily =
                            new System.Windows.Media.FontFamily(string.Format(@"/Assets/Fonts/{0}#{1}", filename,
                ...
                if (view.IsUnderline && !string.IsNullOrEmpty(view.Text))
                {
                    try
                    {
                        ...
                        System.Windows.Documents.Underline ul = new System.Windows.Documents.Underline();
